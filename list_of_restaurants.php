    ...
    <center>
      ...
      <table border="1">
       ...
       <?php
        ...
        $connectionOptions = array("Database" => "APULab2Exercise","Uid" => "APUAdmin","PWD" => "Sixfourtwo624");
        ...
        {
          echo "<tr>";echo "<td>". $row['restaurant_id'] . "</td>";
          echo "<td>". $row['restaurant_name'] ."</td>";echo "<td>". $row['restaurant_address'] . "</td>";
          echo "<td>". $row['restaurant_phone'] . "</td>";echo "</tr>";}
